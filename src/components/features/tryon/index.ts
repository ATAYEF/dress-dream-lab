/** Try-on / outfit builder feature exports */
export { OutfitBuilder } from '@/components/OutfitBuilder';
export { MannequinDisplay } from '@/components/MannequinDisplay';
...
export { ColorHarmonyBadge } from '@/components/ColorHarmonyBadge';
export { GeneratingBanner } from '@/components/GeneratingBanner';
