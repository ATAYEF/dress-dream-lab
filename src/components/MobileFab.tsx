...
export const MobileFab: React.FC<MobileFabProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'md:hidden fixed z-40 touch-manipulation touch-target',
        'flex items-center gap-2 px-4 py-3 rounded-full min-h-[48px]',
        ...
        isGenerate
          ? 'right-3 left-auto translate-x-0 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-rose-500 shadow-lg shadow-fuchsia-500/30'
          : 'left-1/2 -translate-x-1/2 bg-gradient-to-r from-[hsl(42,85%,58%)] via-[hsl(38,85%,52%)] to-[hsl(35,78%,45%)] shadow-lg shadow-[hsl(42,85%,45%)/0.4]',
        className
      )}
    >
